...
class JsonOutlineProvider {
    constructor(context) {
        ...
        this._onDidChangeTreeData = new vscode.EventEmitter();
        this.onDidChangeTreeData = this._onDidChangeTreeData.event;
        this.autoRefresh = (_a = vscode.workspace.getConfiguration('jsonOutline').get('autorefresh')) !== null && _a !== void 0 ? _a : true;
    ...
    // 检测当前是否打开json文件，是则开启jsonOutline并刷新
    ...
    onDocumentChanged(changeEvent) {
        var _a, _b;
        if (this.autoRefresh &&
            changeEvent.document.uri.toString() === ((_a = this.editor) === null || _a === void 0 ? void 0 : _a.document.uri.toString())) {
            for (const change of changeEvent.contentChanges) {
                const path = json.getLocation((_b = this.text) !== null && _b !== void 0 ? _b : '', this.editor.document.offsetAt(change.range.start)).path;
                path.pop();
                const node = path.length && this.tree ? json.findNodeAtLocation(this.tree, path) : void 0;
                this.parseTree();
...
/* harmony export */ });
/* harmony import */ var _impl_format__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
/* harmony import */ var _impl_edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
/* harmony import */ var _impl_scanner__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8);
/* harmony import */ var _impl_parser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(10);
/*---------------------------------------------------------------------------------------------
...
/* harmony export */ });
/* harmony import */ var _scanner__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony export */ });
/* harmony import */ var _format__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
/* harmony import */ var _parser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
const JsonOutlineProvider_1 = __webpack_require__(5);
function activate(context) {
    const rootPath = vscode.workspace.workspaceFolders && vscode.workspace.workspaceFolders.length > 0
        ? vscode.workspace.workspaceFolders[0].uri.fsPath
        : undefined;
    //#region nodeDependencies
    // 注册名为'nodeDependencies'的视图
    ...
    // 点击时会执行DepNode的command
    vscode.commands.registerCommand('extension.openPackageOnNpm', moduleName => vscode.commands.executeCommand('vscode.open', vscode.Uri.parse(`https://www.npmjs.com/package/${moduleName}`)));
    // 刷新Item时
    vscode.commands.registerCommand('nodeDependencies.refresh', (node) => {
        console.log(node);
        vscode.window.showInformationMessage(`Successfully called refresh on ${node.label}.`);
    });
    //#endregion
    //#region jsonOutlineProvider
    const jsonOutlineProvider = new JsonOutlineProvider_1.JsonOutlineProvider(context);
